...
AWS.config.update({ region: 'us-east-2' }); //t0d
...
var customAuth = function (req, res, next) {
    console.log('req.headers==>', req.headers); //t0d
    let id_token = req.headers.authorization;
    console.log('id_token==>', id_token); //t0d
    var decoded = jwtDecode(id_token);
    console.log('decoded==>', decoded); //t0d
    
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
        // IdentityPoolId: process.env.ID_POOL,
        // IdentityPoolId: 'INSERT_YOUR_COGNITO_POOL_ID_HERE',
        IdentityPoolId: 'us-east-2:353326bc-40d4-4ee2-92e4-4c5817be3324',
        Logins: {
